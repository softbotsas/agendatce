$(document).ready(function () {
    ...
    function inicializarDatatable(datos) {
      ...
      datatable = $('#kt_datatable_guia_0').KTDatatable({
   ...
   // cargarGuias();
    ...
    $('#informacion_comi').click(function () {
      ...
      $.ajax({
        url: '/guia_pdt_registrar_agencia', // Asegúrate de que esta URL es correcta
        method: 'GET',
        data: {
          desde: desde,
          hasta: hasta,
    ...
    function exportToExcelX() {
        ...
        const table = document.getElementById('kt_datatable_guia_0'); // ID de la tabla
