        ...
        var datatable = $('#kt_datatable_preguia').KTDatatable({
          ...
          template: function(row) {
            return '\
                           ...
                           <form action="/agencia/delete/' + row._id + '?_method=DELETE" method="POST" style="display:inline;">\
                            ...
                            <a href="sistematce.com/qr_agencia/' + row._id + '/' + encodeURIComponent(row.NOMBRE) + '" class="btn btn-sm btn-clean btn-icon mr-2" title="Ver QR">\
        <span class="svg-icon svg-icon-md">\
