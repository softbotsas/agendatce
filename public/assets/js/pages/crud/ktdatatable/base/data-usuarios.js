    ...
    var demo = function() {
        var datatable = $('#kt_datatable_usuarios').KTDatatable({
          ...
          template: function(row) {
            return '\
							<a href="/user/edit/' + row._id + '" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
                             ...
                             <a href="/lista_movimientos_usuario/' + row._id + '" class="btn btn-sm btn-clean btn-icon mr-2" title="Movimientos Usuario">\
	                            <span class="svg-icon svg-icon-md">\
